...
const Homepage = () => {
  return (
    <div id='home' className='w-full h-88 bg-center bg-no-repeatscroll-mt-20 relative sm:h-screen bg-cover' style={{ backgroundImage: `url('/Images/image.jpg')` }}>
      <div className='absolute inset-0 bg-gradient-to-b from-deepPurple/80 to-transparent'>
      <div className='mx-5 mt-36 sm:mx-12 lg:mx-24 sm:my-60 lg:my-40 text-white'>
